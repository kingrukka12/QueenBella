...
module.exports = {
    ...
    SESSION: process.env.AMDI_SESSION === undefined ? '' : process.env.BELLA_SESSION,
    ...
    OWN2: process.env.OWN2 === undefined ? '94761444438,0' : process.env.OWN,
    DEBUG: DEBUG,
